...
urlpatterns = [
    ...
    path(
        "register_next_to_order/",
        views.CreateProfileOrder.as_view(),
        name="register_next_to_order",
    ),
    path("block_page/", views.BlockView.as_view(), name="block_page"),
    path("account/<int:pk>/", views.DetailAccount.as_view(), name="account"),
    path(
        "history_view/<int:pk>/", views.HistoryDetailView.as_view(), name="history_view"
    ),
    path("profile/<int:pk>/", views.DetailProfile.as_view(), name="profile"),
    path(
        "profile/<int:pk>/comment_list",
