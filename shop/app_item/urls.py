...
urlpatterns = [
    path(
        "list/best_seller", views.ItemBestSellerList.as_view(), name="item_best_seller"
    ),
    ...
    path("list/store/<slug:slug>/", views.StoreItemList.as_view(), name="store_list"),
    path("list/remove_param/<slug:param>/", views.remove_param, name="remove_param"),
